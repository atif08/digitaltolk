...
export default class NotifService {
  ...
  createDefaultChannels() {
    PushNotification.createChannel(
      {
        channelId: "groupChatId", // (required)
        channelName: `Group Chat Channel`, // (required)
    ...
    //     vibrate: true, // (optional) default: true. Creates the default vibration patten if true.
    //   },
    //   (created) => console.warn(`createChannel 'sound-channel-id' returned '${created}'`) // (optional) callback returns whether the channel was created, false means it already existed.
    // );
  }
  ...
  popInitialNotification() {
    PushNotification.popInitialNotification((notification) => console.warn('InitialNotication:', notification));
  }
  ...
  localNotif(item) {
    ...
    PushNotification.localNotification({
      ...
      bigText: item.text, // (optional) default: "message" prop
      subText: item.createdAt, // (optional) default: none
